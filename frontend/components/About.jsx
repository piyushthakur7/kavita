      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-14 items-center">
        <div className="relative">
          <div className="relative rounded-[280px] overflow-hidden h-[520px] lg:h-[640px] bg-[#efeefb]">
            <img src={aboutImage} alt="Clinic" className="w-full h-full object-cover" />
          </div>
          <div className="absolute -right-2 bottom-10 lg:right-6 lg:bottom-16 bg-white p-3 rounded-2xl shadow-2xl w-[210px]">
            <img src={drImage} alt="Dr. Kavita Kabira" className="w-full h-44 object-cover rounded-xl" />
            <div className="px-1 py-3">
              <h4 className="font-serif-display text-[19px] text-[#1c1a1f] leading-tight">Dr. Kavita Kabira Bhutani</h4>
              <p className="text-[11px] uppercase tracking-[0.18em] text-[#7e7a86] mt-1">Psychologist & Mindset Coach</p>
        ...
        <div>
          ...
          <div className="mt-7 space-y-5 text-[15.5px] leading-relaxed text-[#4b4753]">
            <p>
              ...
              <strong className="text-[#1c1a1f]">Best Psychologist in Gurgaon</strong> to navigate these issues.
            </p>
            <p>
              Acknowledging this essential need, we have established a dedicated psychological
              practice. As the <strong className="text-[#1c1a1f]">Top Psychotherapist in Gurgaon and Delhi</strong>,
              ...
              <strong className="text-[#1c1a1f]">affordable psychologist</strong> for everyone seeking guidance.
            </p>
