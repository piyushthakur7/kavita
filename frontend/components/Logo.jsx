  ...
  return (
    <Link href="/" className="flex items-center gap-3 group">
      ...
      <div className="leading-tight">
        <div className={`font-serif-display tracking-[0.18em] font-semibold text-[15px] ${light ? 'text-white' : 'text-[#1c1a1f]'}`}>
          KAVITA KABIRA
        </div>
        <div className={`text-[9px] tracking-[0.45em] font-medium ${light ? 'text-white/70' : 'text-[#1c1a1f]/60'}`}>
          WELLNESS CLINIC
        </div>
      </div>
    </Link>
