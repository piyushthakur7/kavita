    ...
    return (
      <>
        ...
        <section className="py-24 text-center">
          <Link href="/blog" className="btn-outline-dark">Back to Blog</Link>
        </section>
      </>
    );
  }
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 grid lg:grid-cols-3 gap-12">
          <article className="lg:col-span-2">
            ...
            <div className="mt-12 pt-8 border-t border-gray-200 flex items-center justify-between flex-wrap gap-4">
              <Link href="/blog" className="inline-flex items-center gap-2 text-[13px] font-semibold uppercase tracking-[0.2em] text-[#1c1a1f] hover:text-fuchsia-700">
          ...
          <aside className="lg:col-span-1">
            <div className="bg-[#f5f4ef] rounded-3xl p-7 sticky top-28">
              ...
              <ul className="space-y-5">
                {others.map((o) => (
                  <li key={o.id}>
                    <Link href={`/blog/${o.id}`} className="flex gap-4 group">
