    ...
    <section id="services" className="py-24 lg:py-32 section-light">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
        <div className="max-w-3xl">
          ...
          <div className="mt-8">
            <a href="#contact" className="btn-outline-dark">View all services</a>
          </div>
        </div>
        ...
        <div className="mt-14 grid md:grid-cols-2 lg:grid-cols-3 gap-7">
          {services.map((s) => (
            <article
              key={s.id}
              className="svc-card group bg-white rounded-3xl overflow-hidden border border-gray-100"
            >
              ...
              <div className="p-7">
                ...
                <p className="text-[12px] uppercase tracking-[0.22em] text-[#9b97a4] mb-3">
                  {s.tag}
                </p>
