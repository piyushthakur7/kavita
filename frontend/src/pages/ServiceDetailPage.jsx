...
import { services, contact } from '../mock';

const ServiceDetailPage = ({ onBookClick }) => {
  const { id } = useParams();
    ...
    return (
      <>
        ...
        <section className="py-24 text-center">
          <Link to="/services" className="btn-outline-dark">Back to Services</Link>
        </section>
      </>
    );
  }
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 grid lg:grid-cols-3 gap-12">
          <article className="lg:col-span-2">
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              <button onClick={onBookClick} className="btn-dark">
          ...
          <aside className="lg:col-span-1">
            <div className="bg-[#f5f4ef] rounded-3xl p-7">
              ...
              <ul className="space-y-4">
                {others.map((o) => (
                  <li key={o.id}>
                    <Link to={`/services/${o.id}`} className="flex items-center gap-4 group">
              ...
              <div className="mt-7 pt-6 border-t border-gray-200">
                <Link to="/services" className="inline-flex items-center gap-2 text-[13px] font-semibold uppercase tracking-[0.2em] text-[#1c1a1f] hover:text-fuchsia-700">
